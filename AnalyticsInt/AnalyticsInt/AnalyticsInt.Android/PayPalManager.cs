...
namespace AnalyticsInt.Droid
{
     ...
     */
        ...
        //Live
        private static string CONFIG_CLIENT_ID = "Ac8VD2nV7gRvp5vDYFTkoHga2bj2JPyOnT01Xp0qd7nfNTTDIW39zTfo7igH1SP5Xqak2uMayOvmu_ui";
        
        //testing
        //private static String CONFIG_CLIENT_ID = "Aan5gfMDyCghE-iKEkyIOOpnzZofoaJe5-US60vJ64kKAHAAzTY53u8r0xfM6yY7PkvibBEVz2kWB6_f";
        ...
        private PayPalPayment getThingToBuy(string paymentIntent)
        {
            try
            {
                return new PayPalPayment(new Java.Math.BigDecimal("0.75"), "USD", "sample item",
    paymentIntent);
                    ...
                    if (confirm != null)
                    {
                        try
                        {
                            ...
                            Toast.MakeText(
                                ...
                                " Payment received from PayPal", ToastLength.Short)
                                .Show();
